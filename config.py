...
class Config(object):
    ...
    ADMINS = ['barman@foyerespci.fr', 'samuel.diebolt@espci.psl.eu', 'prohibition136@gmail.com']
    ...
    MINUTES_BEFORE_NEXT_DRINK = int(os.environ.get('MINUTES_BEFORE_NEXT_DRINK'))
